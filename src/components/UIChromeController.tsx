...
export default function UIChromeController() {
    ...
    return (
        <>
            {/* Back */}
            <div className="fixed left-5 bottom-14 z-30">
                <a
                    href="/"
                    className="pointer-events-auto select-none inline-flex items-center gap-2 rounded-full
                    bg-black/55 backdrop-blur-md ring-1 ring-white/10 shadow-[0_0_16px_rgba(0,150,255,0.25)] px-3
                    py-2 text-xs text-white/90 hover:bg-black/70 focus-visible:outline-none focus-visible:ring-2
            ...
            <div className="fixed right-5 bottom-14 z-30">
                <button
                    type="button"
                    aria-pressed={hidden}
                ...
                >
                    <span className="inline-block h-2.5 w-2.5 rounded-full"
                          style={{background: hidden ? "#38bdf8" : "#94a3b8"}}/>
